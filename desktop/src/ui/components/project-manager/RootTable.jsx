        ...
        <tbody>
          {(localFolders || []).map((f) => {
            ...
            return (
              ...
              >
                ...
                <td className="py-3.5 text-xs text-slate-400 font-medium border-y border-transparent truncate max-w-[420px]">{p}</td>
          ...
          {projects.map((p) => (
            ...
            >
              ...
              <td className="py-3.5 text-xs text-slate-400 font-medium border-y border-transparent truncate max-w-[420px]">{p.path}</td>
              <td className="py-3.5 text-right text-xs text-slate-500 font-medium border-y border-transparent">
